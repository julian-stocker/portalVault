...
**Seit 2026-09-22 stehen BEIDE Umgebungen auf der korrigierten Arbeitsmappe: 806 real ·
0 Fixtures · 0 reserviert · 0 Bewegungen · 2 741 `legacy_stock_events` mit Summe 806**
(ADR-0104, `docs/DATABASE.md` 3.3aj). Die Quelle wurde vor dem Go-Live ein letztes Mal
aktualisiert — Spalte F sank von 824 auf 806 —, und die Angleichung lief in beiden Umgebungen
